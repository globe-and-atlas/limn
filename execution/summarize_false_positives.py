...
def main() -> None:
    ...
    lines.append("")
    lines.append("- FP @ 0.01 is the floor under the *validation* configuration used to state recall; "
                 "it is the apples-to-apples counterpart to the 81.5%/77.8%/66.7% figures.")
    lines.append("- FP @ app threshold reflects the stricter live-viewer highlight cutoff.")
    lines.append("- A defensible public claim pairs each recall number with its FP @ 0.01 on this "
                 "same background set — never recall alone.")
    lines.append("")
